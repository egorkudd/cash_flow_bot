...
public class StatisticCommand extends BotCommand {
    ...
    public StatisticCommand(ConversationService conversationService) {
        super("statistic", "Get statistic command");
    ...
    private void startConversation(Long chatId, AbsSender absSender) {
        conversationService.startConversation(chatId, EConversation.STATISTIC, absSender);
    }
